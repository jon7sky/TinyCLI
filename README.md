...
ST's STM32CubeIDE tool to build and load the firmware. The input/output goes through the ST-Link's built-in virtual COM port,
which communicates with the STM32 through one of the UARTs. 
